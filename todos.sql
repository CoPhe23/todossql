...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Sze 24. 11:42
...
-- Adatbázis: `todos`
--
CREATE DATABASE IF NOT EXISTS `todos` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `todos`;
...
(1, 'Könyvtár', 0, '2025-09-24 06:00:07'),
(3, 'tankolás', 0, '2025-09-24 06:50:52');
